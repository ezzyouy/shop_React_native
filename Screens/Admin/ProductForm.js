...
const ProductForm = (props) => {
  ...
  const [numRevies, setNumRevies] = useState(0);
  ...
  useEffect(() => {
    ...
    async () => {
      if (Platform.OS !== "web") {
        ...
        if (status !== "granted") {
          alert("Sorry, we need camera roll permissins to make this work!");
        }
      }
    };
  ...
  const addProduct = () => {
    if (
      ...
      setErr("Please fill in the from correctly");
    }
    ...
    formData.append("numRevies", numRevies);
  ...
  return (
    <FormContainer title="Add Product">
      <View style={styles.imageContainer}>
        ...
        <TouchableOpacity onPress={pickImagek} style={styles.imagePicker}>
      ...
      <Item picker>
        <Picker
          mode="dropdown"
          iosIcon={<Icon color={"#007aff"} name="arroe-down" />}
